...
public final class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> VOICE_VICTORY =
            SOUND_EVENTS.register("voice.victory", () -> SoundEvent.createVariableRangeEvent(id("voice.victory")));

    public static final RegistryObject<SoundEvent> VOICE_DEFEAT =
            SOUND_EVENTS.register("voice.defeat", () -> SoundEvent.createVariableRangeEvent(id("voice.defeat")));
